...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for idx, char in enumerate(VOWELS_LOWER):
            r_dict[char] = vowels_permutation[idx]
            r_dict[char.upper()] = vowels_permutation[idx].upper()
        for letter in CONSONANTS_LOWER:
            r_dict[letter] = letter
            r_dict[letter.upper()] = letter.upper()
        return r_dict
    ...
    def apply_transpose(self, transpose_dict):
        ...
        for idx, char in enumerate(mt_list):
            if char in transpose_dict:
                mt_list[idx] = transpose_dict[char]
        return ''.join(mt_list)
